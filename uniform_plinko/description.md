...
In any real-life Plinko board I have observed, the probability of going left at
...
At this point, we have a system of equations! That is, an equation per
...
(1 - x_1) * (1 - x_3) = 1 / 3
```
In general, this system will be underdetermined. For a depth n
...
### Depth 5
<img src="./static/plinko_solution_5.svg" width="100%" height="500px"/>

### Depth 10
Using the above python code, this solution took around 10 seconds to
compute.

<img src="./static/plinko_solution_10.svg" width="100%" height="500px"/>
